...
public class VistaModificarIdHangar extends JFrame implements Observador {
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.MODIFICAR_HANGAR_ID, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.MODIFICAR_HANGAR_ID, 0));
				}
			}
		});
