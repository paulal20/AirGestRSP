...
public class VistaAbrirCarrito extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Abrir Carrito");
		...
		textoId.setToolTipText("Aqui va el id del empleado al que pertenezca la venta (Entero mayor que 0)");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.ABRIR_VENTA, id));
					dispose();
