...
public class VistaBajaEmpleado extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Baja Empleado");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.BAJA_EMPLEADO, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.VISTA_FALLO_BAJA_EMPLEADO));
				}
			}
