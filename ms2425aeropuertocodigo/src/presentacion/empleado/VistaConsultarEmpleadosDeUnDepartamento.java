...
public class VistaConsultarEmpleadosDeUnDepartamento extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Consultar Empleado por Departamento");
		...
		JLabel etiquetaA = new JLabel("id Departamento: ");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					int idDepartamento = Integer.valueOf(textoA.getText());

					ctrl.accion(new Contexto(Evento.CONSULTAR_EMPLEADOS_POR_DEPARTAMENTO, idDepartamento));

				} catch (Exception ex) {
					ctrl.accion(new Contexto(Evento.CONSULTAR_EMPLEADOS_POR_DEPARTAMENTO, 0));
				}
			}
		});
